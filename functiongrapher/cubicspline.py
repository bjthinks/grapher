...
import unittest
from function import Function, WrappedFunction
from interval import Interval


class CubicSpline(WrappedFunction):
    ...
    def endpoint_slope_factory(t0, t1, f0, f1, d0, d1):
        c0 = f0 + d0 * (t1 - t0) / 3
        c1 = f1 - d1 * (t1 - t0) / 3
        return CubicSpline(t0, t1, f0, c0, c1, f1)
...
class _CubicSplineUnitTests(unittest.TestCase):
    def test_zero(self):
        zero_cubic = CubicSpline(0, 1, 0, 0, 0, 0)
    ...
    def test_line(self):
        line_cubic = CubicSpline(0, 1, 2, 4, 6, 8)
    ...
    def test_translated_line(self):
        line_cubic = CubicSpline(2, 5, 2, 4, 6, 8)
    ...
    def test_parabola(self):
        parabola = CubicSpline(0, 3, 0, 0, 3, 9)
    ...
    def test_weird_cubic(self):
        ...
        cubic = CubicSpline(1, 4, 0, 4.5, -4.5, 0)
    ...
    def test_control_point_read_back(self):
        cubic = CubicSpline(10, 20, 30, 40, 50, 60)
    ...
    def test_endpoint_slope_factory(self):
        ...
        cubic = CubicSpline.endpoint_slope_factory(0, 1, 1, 3, 2, 3)
